...
This package is developed by Mr. Ke Zhu (http://www.lamda.nju.edu.cn/zhuk/) and we are trying to add the implementation code of ViT models, and . If you have any problem about the code, please feel free to contact Mr. Ke Zhu (zhuk@lamda.nju.edu.cn). The package is free for academic usage. You can run it at your own risk. For other purposes, please contact Prof. Jianxin Wu (mail to 
wujx2001@gmail.com).
