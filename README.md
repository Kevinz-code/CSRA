...
This package is developed by Ke Zhu (http://www.lamda.nju.edu.cn/zhuk/), and we also thank Lin Sui for his contribution (http://www.lamda.nju.edu.cn/suil/). If you have any problem about the code, please feel free to contact Mr. Ke Zhu (zhuk@lamda.nju.edu.cn). The package is free for academic usage. You can run it at your own risk. For other purposes, please contact Prof. Jianxin Wu (mailto:wujx2001@gmail.com).
